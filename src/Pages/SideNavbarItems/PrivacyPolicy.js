  ...
  return (
    <>
      <div className="privacy-policy" style={{padding:"10px"}}>
        ...
        <p>
          Jay Gangani built the Piano Kids Music &amp; Songs Guide app as a Free
          app. This SERVICE is provided by Jay Gangani at no cost and is
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Piano Kids Music &amp;
          Songs Guide unless otherwise defined in this Privacy Policy.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          not hesitate to contact me at jayganganiapps@gmail.com.
        </p>{" "}
        <p>
